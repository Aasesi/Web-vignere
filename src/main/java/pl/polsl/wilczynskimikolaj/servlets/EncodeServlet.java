...
public class EncodeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String encodedText = "";
        try {
            encodedText = model.encode(text, key);
            Operation operation = new Operation("Encode", encodedText, text, key);
            ...
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Error during encoding");
            return;
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Result: " + encodedText + "</h1>");
            int count = 0;
            ...
            count++;
            out.println("Number of times you encoded:" + String.valueOf(count));
            out.println("</body>");
            out.println("</html>");
